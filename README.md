...
#### [Проблема](#Проблема-1)
#### [1.	Создаем dimens.xml, colors.xml, strings.xml ресурсы](#Создаем-dimensxml-colorsxml-stringsxml-ресурсы)
#### [2.	Создаем styles_text.xml](#Создаем-styles_text.xml)
#### [3.	Создаем файлы для компонентов](#Создаем-файлы-для-компонентов)
#### [4.	Создаем тему нашего приложения](#Создаем-тему-нашего-приложения)
#### [5.	Проходимся по нашим экранам перерабатывая на новый стиль](#Проходимся-по-нашим-экранам-перерабатывая-на-новый-стиль)
#### [6.	Чистим и удаляем все deprecated стили](#Чистим-и-удаляем-все-deprecated-стили)
